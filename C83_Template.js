...
var names = ["Family Book","Girja Shenker Upadhyay - Grandfather", "Henuman Prasad Upadhyay - Father", "Preeti Upadhyay - Mother", "Shagun Upadhyay - Sister"];
...
function update()
{
    ...
    document.getElementById("family_member_name").src = image;;
